...
#import "/Users/ymq/Desktop/SimpleDemo/Swift_Sound/Swift_Sound/Swift_Sound-Bridging-Header.h"
...
SWIFT_MODULE_NAMESPACE_PUSH("Swift_Sound")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC11Swift_Sound11AppDelegate")
...
SWIFT_CLASS("_TtC11Swift_Sound14ViewController")
@interface ViewController : UIViewController <AVSpeechSynthesizerDelegate, GCDWebUploaderDelegate>
- (void)viewDidLoad;
- (void)viewWillDisappear:(BOOL)animated;
- (void)handleInterreptionWithSender:(NSNotification * _Nonnull)sender;
- (void)startWithBtn:(UIButton * _Nonnull)btn;
- (void)didReceiveMemoryWarning;
- (void)webUploader:(GCDWebUploader * _Nonnull)uploader didUploadFileAtPath:(NSString * _Nonnull)path;
- (void)webUploader:(GCDWebUploader * _Nonnull)uploader didMoveItemFromPath:(NSString * _Nonnull)fromPath toPath:(NSString * _Nonnull)toPath;
- (void)webUploader:(GCDWebUploader * _Nonnull)uploader didCreateDirectoryAtPath:(NSString * _Nonnull)path;
